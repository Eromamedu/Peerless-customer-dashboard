...
export default function AppShell({
  ...
  return (
    <div className="min-h-screen w-full bg-[#07111f] text-slate-200">
        ...
        >
          <div className="flex h-full flex-col">
            ...
            <nav className="flex-1 px-4 py-7">
              ...
              <p className="mb-4 px-3 text-[10px] font-bold uppercase tracking-[0.18em] text-slate-600">
                Workspace
              </p>
              ...
              <Link
                to="/customers"
                className={`
                  group mb-2 flex w-full items-center gap-3
